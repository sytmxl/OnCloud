<template>
  <div class="flex items-center flex-grow">
    <svg class="m-auto" style="max-height: 150px;enable-background:new 0 0 268.1 237;"
      version="1.1" id="图层_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      viewBox="0 0 268.1 237"  xml:space="preserve">
...
<style type="text/css" scoped>
  .st0{opacity:0.25;fill:none;stroke:var(--md-sys-color-primary);stroke-width:6;stroke-miterlimit:10;enable-background:new    ;}
  .st1{opacity:0.25;}
  .st2{fill:var(--md-sys-color-primary);}
</style>
